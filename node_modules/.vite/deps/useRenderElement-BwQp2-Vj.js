...
//#region node_modules/@base-ui/utils/createLogOnce.mjs
	...
	return function logOnce(...messages) {
		{
			...
			if (!loggedMessages.has(key)) {
				...
				if (severity === "warn") console.warn(output);
...
function evaluateRenderProp(element, render, props, state) {
	if (render) {
		...
		if (!/*#__PURE__*/ import_react.isValidElement(render)) throw new Error([
...
//#endregion
export { isReactVersionAtLeast as a, EMPTY_OBJECT as c, useRefWithInit as d, createLogOnce as f, resolveStyle as i, NOOP as l, makeEventPreventable as n, useMergedRefs as o, mergeProps as r, EMPTY_ARRAY as s, useRenderElement as t, warn as u };
